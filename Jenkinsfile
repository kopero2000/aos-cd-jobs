    ...
    node() {
            ...
            [
                ...
                [
                    ...
                    parameterDefinitions: [
                        ...
                        booleanParam(
                            name: 'LOAD_DISABLED',
                            description: 'Load also disabled components (passes --load-disabled to doozer subcommands)',
                            defaultValue: false,
                        ),
                        booleanParam(
                            name: 'LIVE_TEST_MODE',
                            description: 'Run in test mode (passes --live-test-mode to doozer subcommands)',
                            defaultValue: false,
                        ),
                        commonlib.mockParam(),
                    ]
        ...
        stage("Sync CI Images") {
            sshagent(["openshift-bot"]) {
                ...
                if (params.LOAD_DISABLED) {
                    cmd << "--load-disabled"
                }
                if(params.LIVE_TEST_MODE) {
                    cmd << "--live-test-mode"
                }
